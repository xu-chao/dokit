...
import 'package:dokit/custom_extend/bean/url_bean.dart';
...
void main() {
  ...
  DoKit.runApp(
      ...
      exceptionCallback: (dynamic obj, StackTrace trace) {
        print('exceptionCallback obj $obj \ntrace: $trace');
      });
  // runApp(MyApp());
  ...
  DoKitController.initUrlSwitch([
    UrlBean(
        desc: "基地址1",
        productUrl: "https://honghu.17u.cn/platformopenapi/xt/",
        qaUrl: "https://honghu.qa.17u.cn/platformopenapi/xt/"),
    UrlBean(
        desc: "基地址2",
        productUrl: "https://honghu.17u.cn/platformopenapi/xt/",
        qaUrl: "https://honghu.qa.17u.cn/platformopenapi/xt/")
  ]).then((value) {
    var url = DoKitController.getUrl();
    print("getUrl $url");
  });
  ...
  // List<BizKit> bizKits = [];
  // for (int i = 0; i < 9; i++) {
  //   var bizKit = DoKit.i.newBizKit(name: '$i', group: '业务专区3');
  //   bizKits.add(bizKit);
  // }
  // DoKit.i.addBizKits(bizKits);
}
