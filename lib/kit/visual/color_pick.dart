...
class ColorPickerWidgetState extends State<ColorPickerWidget> {
  ...
  Future<void> _updateColor() async {
    ...
    ///image包下的Color
    var colorPixel =
        image?.getPixelInterpolate(center.dx.toInt(), center.dy.toInt());
    if (colorPixel == null) {
      return;
    }
    print('_updateColor colorPixel $colorPixel');
    ColorPickerKit.instance.color.value = Color.fromARGB(colorPixel.a.toInt(),
        colorPixel.r.toInt(), colorPixel.g.toInt(), colorPixel.b.toInt());
  }
